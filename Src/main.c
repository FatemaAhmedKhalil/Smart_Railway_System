...
int main()
{
	...
	GPIO_u8SetGPIOPinMode			(GPIO_PORTB, GPIO_PIN12, GPIO_MODER_OUTPUT);
	GPIO_voidSetAlternativeFunction	(GPIO_PORTB, GPIO_PIN12, AF5);

	GPIO_u8SetGPIOPinMode			(GPIO_PORTB, GPIO_PIN13, GPIO_MODER_OUTPUT);
	GPIO_voidSetAlternativeFunction	(GPIO_PORTB, GPIO_PIN13, AF5);

	GPIO_u8SetGPIOPinMode			(GPIO_PORTB, GPIO_PIN14, GPIO_MODER_OUTPUT);
	GPIO_voidSetAlternativeFunction	(GPIO_PORTB, GPIO_PIN14, AF5);

	GPIO_u8SetGPIOPinMode			(GPIO_PORTB, GPIO_PIN15, GPIO_MODER_OUTPUT);
